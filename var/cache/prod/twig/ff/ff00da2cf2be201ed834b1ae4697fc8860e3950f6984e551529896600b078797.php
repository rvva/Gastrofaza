...
class __TwigTemplate_411d306ab924415697305c2529c3e32ab71151d6be013e1630b1b2658a86cb35 extends \Twig\Template
{
    ...
    {
        // line 26
        $context["layoutTitle"] = $this->env->getExtension('Symfony\Bridge\Twig\Extension\TranslationExtension')->trans("Information about customer %name%", ["%name%" => ((twig_slice($this->env, $this->getAttribute($this->getAttribute((isset($context["customerInformation"]) ? $context["customerInformation"] : null), "personalInformation", []), "firstName", []), 0, 1) . ". ") . $this->getAttribute($this->getAttribute((isset($context["customerInformation"]) ? $context["customerInformation"] : null), "personalInformation", []), "lastName", []))], "Admin.Orderscustomers.Feature");
        // line 28
  ...
  <div class=\"row\">
    ";
        // line 51
        echo $this->env->getExtension('PrestaShopBundle\Twig\HookExtension')->renderHook("displayAdminCustomers", ["id_customer" => $this->getAttribute($this->getAttribute((isset($context["customerInformation"]) ? $context["customerInformation"] : null), "customerId", []), "value", [])]);
        echo "
...
";
  ...
  ";
    ...
    {
        return new Source("", "@PrestaShop/Admin/Sell/Customer/view.html.twig", "/home/pomarex16/domains/gastrofaza.dark-side.eu/public_html/src/PrestaShopBundle/Resources/views/Admin/Sell/Customer/view.html.twig");
    }
}
