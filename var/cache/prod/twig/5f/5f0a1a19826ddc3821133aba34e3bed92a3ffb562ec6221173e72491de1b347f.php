...
class __TwigTemplate_cd16ab58ab25606493190bc849ad55e37d4406e0182b6ffea1f588624bd57011 extends \Twig\Template
{
...
(isset($context["app"]) ? $context["app"] : null), "request", []), "query", []), "get", [0 => "id_cms_category"], "method")]), "desc" => $this->env->getExtension('Symfony\Bridge\Twig\Extension\TranslationExtension')->trans("Add new page category", [], "Admin.Design.Help"), "icon" => "add_circle_outline"], "add_cms_page" => ["href" => $this->env->getExtension('Symfony\Bridge\Twig\Extension\RoutingExtension')->getPath("admin_cms_pages_create", ["id_cms_category" => $this->getAttribute($this->getAttribute($this->getAttribute(        // line 35
(isset($context["app"]) ? $context["app"] : null), "request", []), "query", []), "get", [0 => "id_cms_category"], "method")]), "desc" => $this->env->getExtension('Symfony\Bridge\Twig\Extension\TranslationExtension')->trans("Add new page", [], "Admin.Design.Help"), "icon" => "add_circle_outline"]];
        // line 26
  ...
  ";
    ...
    public function block_cms_category_grid($context, array $blocks = [])
    {
      ...
      <div class=\"col\">
        ";
        // line 57
        $this->loadTemplate("@PrestaShop/Admin/Improve/Design/Cms/index.html.twig", "@PrestaShop/Admin/Improve/Design/Cms/index.html.twig", 57, "907921718")->display(twig_array_merge($context, ["grid" => (isset($context["cmsCategoryGrid"]) ? $context["cmsCategoryGrid"] : null)]));
        // line 65
        echo "      </div>
    </div>
  ";
    ...
    public function block_cms_grid($context, array $blocks = [])
    {
      ...
      <div class=\"col\">
        ";
        // line 72
        $this->loadTemplate("@PrestaShop/Admin/Common/Grid/grid_panel.html.twig", "@PrestaShop/Admin/Improve/Design/Cms/index.html.twig", 72)->display(twig_array_merge($context, ["grid" => (isset($context["cmsGrid"]) ? $context["cmsGrid"] : null)]));
        // line 73
        echo "      </div>
    </div>
  ";
...
";
    ...
    {
        return new Source("", "@PrestaShop/Admin/Improve/Design/Cms/index.html.twig", "/home/pomarex16/domains/gastrofaza.dark-side.eu/public_html/src/PrestaShopBundle/Resources/views/Admin/Improve/Design/Cms/index.html.twig");
    }
}


/* @PrestaShop/Admin/Improve/Design/Cms/index.html.twig */
class __TwigTemplate_cd16ab58ab25606493190bc849ad55e37d4406e0182b6ffea1f588624bd57011___907921718 extends \Twig\Template
{
    public function __construct(Environment $env)
    {
        parent::__construct($env);
    ...
    public function block_grid_panel_footer($context, array $blocks = [])
    {
        // line 60
        echo "              ";
        if (($this->getAttribute($this->getAttribute($this->getAttribute((isset($context["app"]) ? $context["app"] : null), "request", []), "query", []), "get", [0 => "id_cms_category"], "method") && ($this->getAttribute($this->getAttribute($this->getAttribute((isset($context["app"]) ? $context["app"] : null), "request", []), "query", []), "get", [0 => "id_cms_category"], "method") != $this->getAttribute((isset($context["cmsPageView"]) ? $context["cmsPageView"] : null), "root_category_id", [])))) {
            // line 61
            echo "                ";
