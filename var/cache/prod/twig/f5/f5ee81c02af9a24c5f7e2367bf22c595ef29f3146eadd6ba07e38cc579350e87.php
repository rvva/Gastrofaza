...
class __TwigTemplate_2762ec8c977a23460d81db6cb842b6833330ae331a753f572101cf7dd418f8be extends \Twig\Template
{
    ...
    <div class=\"card col-9\">
      <div class=\"card-body\">
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["module"]) {
            ...
            echo "\"";
            if (((isset($context["selectedModule"]) ? $context["selectedModule"] : null) == $this->getAttribute($context["module"], "id", []))) {
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["hook"]) {
            ...
            echo "</span>
                <label class=\"badge badge-primary badge-pill float-right\">
                  ";
            // line 90
            if (($this->getAttribute($context["hook"], "modules_count", [], "array") && (isset($context["canMove"]) ? $context["canMove"] : null))) {
                // line 91
            ...
            if ($this->getAttribute($context["hook"], "modules_count", [], "array")) {
                ...
                foreach ($context['_seq'] as $context["_key"] => $context["module"]) {
                    if ($this->getAttribute((isset($context["modules"]) ? $context["modules"] : null), $this->getAttribute($context["module"], "id_module", [], "array"), [], "array", true, true)) {
                        // line 107
                        echo "                      ";
                        $context["moduleInstance"] = $this->getAttribute((isset($context["modules"]) ? $context["modules"] : null), $this->getAttribute($context["module"], "id_module", [], "array"), [], "array");
                        // line 108
                        echo "                      <li id=\"";
                        echo twig_escape_filter($this->env, (($this->getAttribute($context["hook"], "id_hook", [], "array") . "_") . $this->getAttribute((isset($context["moduleInstance"]) ? $context["moduleInstance"] : null), "id", [])), "html", null, true);
                        echo "\"
                        class=\"module-position-";
                        // line 109
                        echo twig_escape_filter($this->env, $this->getAttribute((isset($context["moduleInstance"]) ? $context["moduleInstance"] : null), "id", []), "html", null, true);
                        echo " module-item";
                        if (((isset($context["canMove"]) ? $context["canMove"] : null) && ($this->getAttribute($context["hook"], "modules_count", [], "array") >= 2))) {
                            echo " draggable";
                        }
                        echo "\">
                        ...
                        ";
                        // line 115
                        if (( !(isset($context["selectedModule"]) ? $context["selectedModule"] : null) && ($this->getAttribute($context["hook"], "modules_count", [], "array") > 1))) {
                            // line 116
                        ...
                        <div class=\"module-column-icon\">
                          <img src=\"";
                        // line 142
                        echo twig_escape_filter($this->env, $this->env->getExtension('Symfony\Bridge\Twig\Extension\AssetExtension')->getAssetUrl((("../modules/" . $this->getAttribute((isset($context["moduleInstance"]) ? $context["moduleInstance"] : null), "name", [])) . "/logo.png")), "html", null, true);
                        echo "\" alt=\"";
                        echo twig_escape_filter($this->env, $this->getAttribute((isset($context["moduleInstance"]) ? $context["moduleInstance"] : null), "displayName", []));
                        echo "\" />
                        </div>
                        ...
                        echo "
                            ";
                        // line 148
                        if ($this->getAttribute((isset($context["moduleInstance"]) ? $context["moduleInstance"] : null), "version", [])) {
                            // line 149
                            echo "                              <small class=\"text-muted\">&nbsp;-&nbsp;";
                            echo twig_escape_filter($this->env, sprintf("v%s", $this->getAttribute((isset($context["moduleInstance"]) ? $context["moduleInstance"] : null), "version", [])), "html", null, true);
                            echo "</small>
                            ";
                        }
                        // line 151
                        ...
                        // line 152
                        echo twig_escape_filter($this->env, $this->getAttribute((isset($context["moduleInstance"]) ? $context["moduleInstance"] : null), "description", []));
                        echo "</div>
                        </div>
...
(isset($context["moduleInstance"]) ? $context["moduleInstance"] : null), "id", []), "id_hook" => $this->getAttribute(                        // line 159
$context["hook"], "id_hook", [], "array"), "editGraft" => 1];
                        ...
                        if ((isset($context["selectedModule"]) ? $context["selectedModule"] : null)) {
                            // line 163
                            echo "                              ";
                            $context["linkParams"] = twig_array_merge((isset($context["linkParams"]) ? $context["linkParams"] : null), ["show_modules" => (isset($context["selectedModule"]) ? $context["selectedModule"] : null)]);
                            // line 164
                            echo "                            ";
                        }
                        // line 165
                        ...
                        // line 176
                        echo twig_escape_filter($this->env, $this->env->getExtension('Symfony\Bridge\Twig\Extension\RoutingExtension')->getPath("admin_modules_positions_unhook", ["moduleId" => $this->getAttribute((isset($context["moduleInstance"]) ? $context["moduleInstance"] : null), "id", []), "hookId" => $this->getAttribute($context["hook"], "id_hook", [], "array")]), "html", null, true);
                        echo "\">
...
";
    ...
    {
        return new Source("", "@PrestaShop/Admin/Improve/Design/positions.html.twig", "/home/pomarex16/domains/gastrofaza.dark-side.eu/public_html/src/PrestaShopBundle/Resources/views/Admin/Improve/Design/positions.html.twig");
    }
}
