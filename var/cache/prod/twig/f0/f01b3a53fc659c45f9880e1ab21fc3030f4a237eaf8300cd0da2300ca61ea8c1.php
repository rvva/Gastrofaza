...
";
    ...
    public function block_addon_description($context, array $blocks = [])
    {
      ...
      ";
            ...
            $context['_seq'] = twig_ensure_traversable($this->getAttribute($this->getAttribute((isset($context["module"]) ? $context["module"] : null), "attributes", []), "changeLog", []));
...
";
    ...
    {
        return new Source("", "@PrestaShop/Admin/Module/Includes/card_notification_update.html.twig", "/home/pomarex16/domains/gastrofaza.dark-side.eu/public_html/src/PrestaShopBundle/Resources/views/Admin/Module/Includes/card_notification_update.html.twig");
    }
}
